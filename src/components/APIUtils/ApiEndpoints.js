...
export const BUSINESS_INCOME_NAMES_FUNC = (businessId) => {return `business/${businessId}/income_names/`}
export const BUSINESS_SPENDING_NAMES_FUNC = (businessId) => {return `business/${businessId}/spending_names/`}
export const BUSINESS_BALANCES_FUNC = (businessId) =>{return `business/${businessId}/balances/`}
export const BUSINESS_ADATE_ASSET_ACCOUNTS_FUNC = (businessId,adate)=>{return `business/${businessId}/${adate}/asset_accounts/`}
export const BUSINESS_ADATE_INCOMES_FUNC = (businessId,adate)=>{return `business/${businessId}/${adate}/incomes/`}
export const BUSINESS_ADATE_SPENDINGS_FUNC = (businessId,adate)=>{return `business/${businessId}/${adate}/spendings/`}
export const BUSINESS_ADATE_BALANCES_FUNC = (businessId, adate) => {return `business/${businessId}/${adate}/balances`}
